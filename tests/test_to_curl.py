...
def test_returns_curl_string_using_requests_module():
    ...
    assert (
        curl
        == 'curl -X POST -H "User-Agent: python-requests/2.24.0" -H "Accept-Encoding: gzip, deflate" -H "Accept: */*" -H "Connection: keep-alive" -H "Content-Length: 0" -d \'None\' http://1.1.1.1/'
    )
